...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j) 
    res <- fit_washb_glm(d=d, X=i, Y=j,  W=H1a_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H1a_adj_res, here("results/adjusted/H1a_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res <- fit_washb_glm(d=d, X=i, Y=j,  W=H1b_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H1b_adj_res, here("results/adjusted/H1b_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res <- fit_washb_glm(d=d, X=i, Y=j,  W=H1c_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H1c_adj_res, here("results/adjusted/H1c_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res <- fit_washb_glm(d=d, X=i, Y=j,  W=H1d_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H1d_adj_res, here("results/adjusted/H1d_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res<- fit_washb_glm(d=d, X=i, Y=j,  W=H2a_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H2a_adj_res, here("results/adjusted/H2a_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res <- fit_washb_glm(d=d, X=i, Y=j,  W=H2b_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H2b_adj_res, here("results/adjusted/H2b_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res <- fit_washb_glm(d=d, X=i, Y=j,  W=H2c_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H2c_adj_res, here("results/adjusted/H2c_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res <- fit_washb_glm(d=d, X=i, Y=j,  W=H2d_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H2d_adj_res, here("results/adjusted/H2d_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res <- fit_washb_glm(d=d, X=i, Y=j,  W=H2e_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H2e_adj_res, here("results/adjusted/H2e_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res <- fit_washb_glm(d=d, X=i, Y=j,  W=H2f_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H2f_adj_res, here("results/adjusted/H2f_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res <- fit_washb_glm(d=d, X=i, Y=j,  W=H2g_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H2g_adj_res, here("results/adjusted/H2g_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res<- fit_washb_glm(d=d, X=i, Y=j,  W=H2h_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H2h_adj_res, here("results/adjusted/H2h_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res<- fit_washb_glm(d=d, X=i, Y=j,  W=H3a_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H3a_adj_res, here("results/adjusted/H3a_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res<- fit_washb_glm(d=d, X=i, Y=j,  W=H3b_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H3b_adj_res, here("results/adjusted/H3b_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res<- fit_washb_glm(d=d, X=i, Y=j,  W=H4a_W[1:18])#drop month_st1 because colinearity with month_mn causes error
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H4a_adj_res, here("results/adjusted/H4a_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res<- fit_washb_glm(d=d, X=i, Y=j,  W=H4b_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H4b_adj_res, here("results/adjusted/H4b_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res<- fit_washb_glm(d=d, X=i, Y=j,  W=H5a_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H5a_adj_res, here("results/adjusted/H5a_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res<- fit_washb_glm(d=d, X=i, Y=j,  W=H5b_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H5b_adj_res, here("results/adjusted/H5b_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res<- fit_washb_glm(d=d, X=i, Y=j,  W=H5c_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H5c_adj_res, here("results/adjusted/H5c_glm_res.RDS"))
...
for(i in Xvars){
  for(j in Yvars){
    print(i)
    print(j)
    res<- fit_washb_glm(d=d, X=i, Y=j,  W=H5d_W)
    res$X <- i
    res$Y <- j
...
#Save results
saveRDS(H5d_adj_res, here("results/adjusted/H5d_glm_res.RDS"))
...
bind_rows(H1a_adj_res, H1b_adj_res, H1c_adj_res, H1d_adj_res) %>%
  saveRDS("results/adjusted/H1_all_glm_res.RDS")

bind_rows(H2a_adj_res, H2b_adj_res, H2c_adj_res, 
          H2d_adj_res, H2e_adj_res, H2f_adj_res,
          H2g_adj_res, H2h_adj_res) %>%
  saveRDS("results/adjusted/H2_all_glm_res.RDS")

bind_rows(H3a_adj_res, H3b_adj_res) %>% 
  saveRDS("results/adjusted/H3_all_glm_res.RDS")

bind_rows(H4a_adj_res, H4b_adj_res) %>%
  saveRDS("results/adjusted/H4_all_glm_res.RDS")

bind_rows(H5a_adj_res, H5b_adj_res, H5c_adj_res, 
          H5d_adj_res) %>%
  saveRDS("results/adjusted/H5_all_glm_res.RDS")
