  ...
  data <- data %>% 
    mutate(
      ...
      `Exposure` = factor(`Exposure`, 
                          levels = exp_levels, 
                          ordered = TRUE),
      est_clean = case_when(is.infinite(ub) ~ NA,
...
include_graphics(here("figures/bg_enrollment-figure.png"))
```
...
include_graphics(here("figures/k_enrollment-figure.png"))
```
...
plot_list$bg_who_hr <- tables_cleaned$bg_who_hr %>% 
  plot_hr(ylab = "Hazard Ratios of Motor \nMilestone Attainment \nat Year 1",
          ...
          caption = "p-value corrected for false discovery rate: *** <0.01, ** <0.05, * <0.2 \n
^ Hazard ratio of development outcome comparing the 25th and 75th percentile of the \n   EED exposure marker distribution\n
