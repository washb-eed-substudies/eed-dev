...
write.csv(h4_cdi, file=here('tables/eed-dev_h4-cdi.csv'))
print(xtable(h4_cdi), type="html", file=here("tables/eed-dev_h4-cdi.html"))
```
...
write.csv(h5_cdi, file=here('tables/eed-dev_h5-cdi.csv'))
print(xtable(h5_cdi), type="html", file=here("tables/eed-dev_h5-cdi.html"))
```
